...
public partial class TblPmgStaffInitiativesAssignment
{
    ...
    public bool? SiaMgrChecked { get; set; }

    public bool? SiaSupChecked { get; set; }

    public bool? SiaDirChecked { get; set; }
