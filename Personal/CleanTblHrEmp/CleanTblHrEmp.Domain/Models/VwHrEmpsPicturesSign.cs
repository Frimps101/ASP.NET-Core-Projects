...
public partial class VwHrEmpsPicturesSign
{
    ...
    public DateTime EmpPromoDate { get; set; }
    ...
    public string EmpSsno { get; set; } = null!;
    ...
    public bool EmpIsSectionalSecretary { get; set; }

    public bool EmpIsDeptAdministrator { get; set; }
    ...
    public string SupOnames { get; set; } = null!;
    ...
    public decimal EmpLastPromoDate { get; set; }
